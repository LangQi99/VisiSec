  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="card">
      ...
      <div class="text-center mb-8">
        <h1 class="text-4xl font-serif font-bold text-ink mb-4">Record Meeting</h1>
        <p class="text-gray-600">
          Capture audio, video, and context for intelligent analysis
        </p>
      </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
          ...
          <div class="text-sm font-medium text-green-900">Audio</div>
        ...
        <div class="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
          ...
          <div class="text-sm font-medium text-green-900">Front Camera</div>
          <div class="text-xs text-green-600">Active</div>
        </div>
        ...
        <div class="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
          ...
          <div class="text-sm font-medium text-green-900">Rear Camera</div>
          <div class="text-xs text-green-600">Active</div>
        </div>
        ...
        <div class="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
          ...
          <div class="text-sm font-medium text-green-900">IMU Sensors</div>
          <div class="text-xs text-green-600">Active</div>
        </div>
      </div>
